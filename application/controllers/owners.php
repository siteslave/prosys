...
class Owners extends CI_Controller
{
    ...
    {
        $this->layout->view('owners/index_view');
    }
    ...
    public function get_list(){
        ...
        $result = $this->owner->get_list($start, $limit);
    ...
    public function get_list_total(){
        ...
        $total = $this->owner->get_list_total();
    ...
    public function save(){
        ...
        if(empty($data['name'])){
            ...
            if(empty($data['owner_id'])){
                $duplicated = $this->owner->check_duplicate($data['name']);
                if($duplicated){
                    $json = '{"success": false, "msg": "Name duplicated"}';
                }else{
                    $result = $this->owner->save($data['name']);
                    if($result){
                ...
                if($data['name'] == $data['owner_old_name']){
                    //update
    ...
    public function search(){
        ...
        if(empty($query)){
            ...
            $result = $this->owner->search($query);
