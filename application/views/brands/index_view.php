...
<div class="tabbable">
    <ul class="nav nav-pills">
        <li class="active"><a href="#tab1" id="tab_main" data-toggle="tab"><i class="icon-th-list"></i> ยี่ห้อ</a></li>
    </ul>
        ...
        <div class="tab-pane active" id="tab1">
            ...
            <form action="#" class="form-inline form-actions">
                ...
                <div class="input-append">
                    <input class="input-xlarge" id="txt_query" type="text" placeholder="ชื่อ หรือ ปล่อยว่างแสดงทั้งหมด">
