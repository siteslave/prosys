<ul class="breadcrumb">
    ...
    <li class="active">สถานะงานซ่อม</li>
</ul>
...
<div class="tabbable">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tab1">
            <blockquote>
                <p>จัดการข้อมูล สถานะงานซ่อม ทั้งหมดที่มีในฐานข้อมูล</p>
            </blockquote>
    ...
    <div class="modal-body">
        <form action="#" class="form-horizontal">
            ...
            <div class="control-group">
                <label class="control-label" for="txt_name">สถานะ</label>
                <div class="controls">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/apps/status.js"></script>
