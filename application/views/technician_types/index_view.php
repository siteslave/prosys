...
<div class="tabbable">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tab1">
            <blockquote>
                <p>จัดการข้อมูล ประเภทช่าง ทั้งหมดที่มีในฐานข้อมูล</p>
            </blockquote>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/apps/technician_types.js"></script>
