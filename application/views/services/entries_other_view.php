    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tab1">
            <form class="form-horizontal" action="#">
                ...
                <div class="control-group">
                    <label class="control-label" for="txt_product_name">ชื่อรายการ</label>
                    <div class="controls">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/apps/services.entries.other.js"></script>
