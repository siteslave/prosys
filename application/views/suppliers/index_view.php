<ul class="breadcrumb">
    ...
    <li class="active">ทะเบียนบริษัท/ร้านค้า</li>
</ul>

<div class="tabbable">
    <ul class="nav nav-pills">
        <li class="active"><a href="#tab1" id="tab_main" data-toggle="tab"><i class="icon-th-list"></i> ทะเบียนร้านค้า</a></li>

    </ul>
    <div class="tab-content">
        <div class="tab-pane active" id="tab1">
            <blockquote>
                <p>จัดการข้อมูลบริษัท/ร้านค้า ทั้งหมดที่มีในฐานข้อมูล</p>
            </blockquote>
            <form action="#" class="form-inline form-actions">

                <label for="txt_query">ค้นหา</label>
                <div class="input-append">
                    <input class="input-xlarge" id="txt_query" type="text" placeholder="ชื่อร้านค้า หรือ ปล่อยว่างแสดงทั้งหมด...">
...
<div class="modal hide fade" id="mdl_new">
    ...
    <div class="modal-body">
        <form action="#" class="form-horizontal">
            ...
            <input type="hidden" id="txt_supplier_old_name">
            <div class="control-group">
                <label class="control-label" for="txt_name">ชื่อร้านค้า</label>
                <div class="controls">
