<ul class="breadcrumb">
    ...
    <li class="active">อะไหล่ (Spare parts)</li>
</ul>

<div class="tabbable">
    <ul class="nav nav-pills">
        <li class="active"><a href="#tab1" id="tab_main" data-toggle="tab"><i class="icon-th-list"></i> รุ่น</a></li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane active" id="tab1">
            <blockquote>
                <p>จัดการข้อมูล อะไหล่ ทั้งหมดที่มีในฐานข้อมูล</p>
            </blockquote>
            <form action="#" class="form-inline form-actions">

                <label for="txt_query">ค้นหา</label>
                <div class="input-append">
                    <input class="input-xlarge" id="txt_query" type="text" placeholder="ปล่อยว่างเพื่อแสดงทั้งหมด...">
    ...
    <div class="modal-body">
        <form action="#" class="form-horizontal">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="txt_price" data-type="number" class="input-small" placeholder="...">
                </div>
            </div>
        </form>
    </div>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/apps/parts.js"></script>
