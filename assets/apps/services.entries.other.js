$(function(){
                    ...
                    _.each(data.rows, function(v){
                        ...
                        $('#tbl_item_list > tbody').append(
                            '<tr>' +
                                ...
                                '<i class="icon-edit"></i>' +
                                '</a>' +
                                '<a href="javascript:void(0);" data-name="btn_remove_item" class="btn" data-id="'+ v.id +'" title="ลบรายการ"><i class="icon-trash"></i></a> ' +
                                '</div></td>' +
                                '</tr>'
                        );
    ...
    $('a[data-name="btn_remove_item"]').live('click', function(){
        ...
        if(confirm('คุณต้องการลบรายการนี้ใช่หรือไม่?')){
            entries.ajax.remove_item(id, function(err){
                if(err){
                    App.alert(err);
                }else{
